...
Assert-Hash $HandRegionsPath '94180B72F4EFCB877BCBAD8A9B9CDF6BC51A2604D463C817EBD8CF722924628A' 'Right-hand manifest checksum mismatch'
...
Assert-True $Worker.Contains('94180b72f4efcb877bcbad8a9b9cdf6bc51a2604d463c817ebd8cf722924628a') 'Worker hand-manifest integrity pin changed'
